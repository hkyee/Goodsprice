...
abstract class Store {
  ...
  // A function to get TextBlocks
  Future<List<TextBlock>> getTextBlocks(File imageFile);

  // A function to scan text from images
  Future<List<String>> scanText(File imageFile);

  // A function to extract price data
  String extractPriceData(List<String> texts);

  // A function to extract item name
  String extractItemName(List<String> texts, List<TextBlock> textBlocks,
      Rect priceTagBox, List<int> imageRes, double screenWidth);
}

// Seven Eleven Class
class SevenElevenStore extends Store {
  @override
...
// Function to extract Item Name
  String extractItemName(List<String> texts, List<TextBlock> textBlocks,
    ...
    final double heightThreshold = priceTagBox.height * 0.35;
    final double upperLimit =
        (topBoundary + heightThreshold) / priceTagBoxRatio;
...
// KK class
class KKMartStore extends Store {
  @override
  // A function to opne camera and take picture
// Future<XFile?> openCamera(BuildContext context) async {
//   // ? means image can be null
